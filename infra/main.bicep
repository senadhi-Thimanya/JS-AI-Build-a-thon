param webapiName string = 'js-ai-webapi'
...
module webapp 'br/public:avm/res/web/static-site:0.7.0' = {
  ...
  params: {
    ...
    tags: union(tags, { 'azd-service-name': 'webapp' })  // Changed from webappName to 'webapp'
    sku: 'Standard'
  }
}
...
module webapi 'br/public:avm/res/web/site:0.15.1' = {
  ...
  params: {
    kind: 'app'
    name: webapiName
    tags: union(tags, { 'azd-service-name': 'webapi' })  // Changed from webapiName to 'webapi'
    serverFarmResourceId: serverfarm.outputs.resourceId
    siteConfig: {
      alwaysOn: false  // Explicitly disable AlwaysOn for Free tier
    }
  }
}
